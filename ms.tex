...
\begin{figure}
	...
	\caption{
		...
		The \textcolor{atomify-red}{red} and the \textcolor{atomify-green}{green} atoms are integrated normally, except the \textcolor{atomify-green}{green} atoms (gas atoms) have an applied constant acceleration representing the pressure gradient.
...
Here we apply a pressure gradient $\nabla P$ in the $x$-direction on the gas atoms using a constant acceleration $a$
\begin{align}
	a = \frac{\nabla P}{\rho_m},
\end{align}
