...
the user can apply the command \keys{\texttt{\#/atom 1 2.0 \#ffffff}}. Certain built-in atom
types have default values and can be accessed with \keys{\texttt{\#/atom 1 oxygen}} for simplicity.
