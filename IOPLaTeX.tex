...
\todo{Also mention MDDriver and GROMACS+Megamol (delalande2009complex, grottel2015megamol)}
...
We create a new script in Atomify using \keys{\ctrl+N}, and save it (\keys{\ctrl+S}) as \code{run.in}.
...
Each time we add or change a command, we just rerun with \keys{\ctrl+R} to see how it looks like.
...
\todo{Fix so cylinder 2 in fig 4 have same color on all atoms.}
